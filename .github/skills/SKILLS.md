...
# skills:
#   - name: SudoLang
#     description: Pseudolanguage for LLMs, interface-oriented, constraint-based, natural language programming, supports markdown, commands, pattern matching, and more. Used for AI-first programs, chatbots, and code generation.
#     version: 2.0
#     tags: [pseudolanguage, LLM, AI, programming, markdown, commands, pattern-matching, codegen]
#     source: https://github.com/joelgrus/sudolang
# ---
# SudoLang v2.0
