...
Asynchronous data services, each in its own folder. Immutable data only. Adhere to [namespace](../../../apm_modules/kerski/aidd/.apm/skills/aidd-namespace/SKILL.md) guidelines.
...
Pure functional types and associated pure functions. Adhere to [namespace](../../../apm_modules/kerski/aidd/.apm/skills/aidd-namespace/SKILL.md) guidelines.
