...
Lit elements live in the `components/` layer per [structure](../../../apm_modules/kerski/aidd/.apm/skills/aidd-structure/SKILL.md). Consume Observe and void actions from plugins per [service](../../../apm_modules/kerski/aidd/.apm/skills/aidd-service/SKILL.md).
