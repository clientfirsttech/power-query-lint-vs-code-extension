---
name: aidd-upskill
description: Guide for crafting high-quality AIDD skills. Use when creating, reviewing, or refactoring skills in .github/skills/.
---
...
**Skill components:** `.github/skills/aidd-sudolang-syntax`, `.github/skills/aidd-please` (provides RTC think())
...
Commands {
  /aidd-upskill create [name] — scaffold a new skill at .github/skills/aidd-[name]/SKILL.md
...
```
.github/skills/aidd-<verbOrRoleBasedNoun>/
...
Use Riteway AI to write eval tests for skill commands. The Riteway AI skill may be available as `aidd-riteway-ai` in your project's `.github/skills/` directory.
