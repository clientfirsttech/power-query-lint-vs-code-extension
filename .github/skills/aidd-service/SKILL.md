...
Asynchronous data services. Live in the `services/` layer per [structure](../../../apm_modules/kerski/aidd/.apm/skills/aidd-structure/SKILL.md). Adhere to [namespace](../../../apm_modules/kerski/aidd/.apm/skills/aidd-namespace/SKILL.md) for type and function organization.
...
Per [namespace](../../../apm_modules/kerski/aidd/.apm/skills/aidd-namespace/SKILL.md), each function lives in its own file — not a single `-service-functions.ts`.

**Interface file** — types and optionally JSON schemas only. No implementation-specific code. Follow [namespace](../../../apm_modules/kerski/aidd/.apm/skills/aidd-namespace/SKILL.md) for type re-exporting (single import surface for consumers).
...
**Namespace** — `export * as ServiceName from './public.js'`; public.ts re-exports create and helpers. Or `export * as ServiceName from './functions/index.js'` when using a functions module. Per [namespace](../../../apm_modules/kerski/aidd/.apm/skills/aidd-namespace/SKILL.md).
...
- [observe](../../../apm_modules/kerski/aidd/.apm/skills/aidd-observe/SKILL.md) — Observe pattern and helper functions
