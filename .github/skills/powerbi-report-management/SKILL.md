...
| `jq` | Parse and construct JSON payloads | Standard CLI tool — see [COMMON-CLI.md § Tool Selection Rationale](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CLI.md#tool-selection-rationale) |
...
[COMMON-CORE.md § Authentication & Token Acquisition](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CORE.md#authentication--token-acquisition).

For full authentication recipes (interactive, device-code, service principal, managed identity),
see [COMMON-CLI.md § Authentication Recipes](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CLI.md#authentication-recipes).
...
> Read [COMMON-CLI.md § Finding Workspaces and Items in Fabric](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CLI.md#finding-workspaces-and-items-in-fabric)
...
[COMMON-CLI.md § Long-Running Operations](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CLI.md#long-running-operations-lro-pattern).
...
ID by name (per [COMMON-CLI.md](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CLI.md#finding-workspaces-and-items-in-fabric)).
...
1. **Authenticate** → see [COMMON-CLI.md § Authentication Recipes](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CLI.md#authentication-recipes)
