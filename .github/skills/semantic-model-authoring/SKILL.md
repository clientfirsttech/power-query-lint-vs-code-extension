...
| DAX Queries & Metadata Discovery | [semantic-model-consumption](../../../apm_modules/microsoft/skills-for-fabric/skills/semantic-model-consumption/SKILL.md)                     | Read-only DAX queries; use for post-creation validation                                     |
...
| Finding Workspaces/Items         | [COMMON-CLI.md](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CLI.md#finding-workspaces-and-items-in-fabric) | When resolving workspace/item IDs                                                           |
| Fabric Control-Plane API         | [COMMON-CLI.md](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CLI.md#fabric-control-plane-api-via-az-rest)   | When using `az rest` patterns, LRO, pagination                                              |
| Authentication                   | [COMMON-CLI.md](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CLI.md#authentication-recipes)                 | When authenticating with `az login`                                                         |
| Authentication & Token Acquisition | [COMMON-CORE.md § Authentication & Token Acquisition](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CORE.md#authentication--token-acquisition) | Wrong audience = 401; read before any auth issue |
| Core Control-Plane REST APIs | [COMMON-CORE.md § Core Control-Plane REST APIs](../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CORE.md#core-control-plane-rest-apis) | Includes pagination, LRO polling, and rate-limiting patterns |
| Definition Envelope              | [ITEM-DEFINITIONS-CORE.md](../../../apm_modules/microsoft/skills-for-fabric/common/ITEM-DEFINITIONS-CORE.md#semanticmodel)    | When building TMDL definition payloads                                                      |
