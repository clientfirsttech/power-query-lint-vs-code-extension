...
For the full definition envelope and part paths, see [ITEM-DEFINITIONS-CORE.md](../../../../apm_modules/microsoft/skills-for-fabric/common/ITEM-DEFINITIONS-CORE.md#semanticmodel).
...
If the response is `202 Accepted`, poll using the LRO pattern from [COMMON-CLI.md](../../../../apm_modules/microsoft/skills-for-fabric/common/COMMON-CLI.md#long-running-operations-lro-pattern).
