...
Single import surface per type: `<type-name>/<type-name>.ts`. Each constant or function lives in `<exported-name>.ts`; namespace re-export from `public.js`. Types live in the `types/` layer per [structure](../../../apm_modules/kerski/aidd/.apm/skills/aidd-structure/SKILL.md).
