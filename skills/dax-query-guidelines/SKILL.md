...
> Based on work by [RuiRomano](https://github.com/RuiRomano/powerbi-agentic-plugins/blob/main/plugins/powerbi/skills/powerbi-semantic-model/references/DAX-query-guidelines.md), licensed under the [MIT License](https://github.com/RuiRomano/powerbi-agentic-plugins/blob/main/LICENSE).
